                ...
                <form onSubmit={handleSubmit} className="space-y-6" aria-label="Sign in form">
                    <div>
                        ...
                        <input
                            ...
                            className="w-full border-b border-black py-2 text-base focus:outline-none focus:ring-2 focus:ring-blue-300 focus:ring-offset-1"
                    ...
                    <button
                        ...
                        type="submit"
                        className="mt-4 w-full rounded-2xl bg-primary py-3 text-lg text-white focus:outline-none focus:ring-2 focus:ring-blue-400 focus:ring-offset-2"
                        aria-label="Sign in"
                    >
                        Sign In
                    </button>
